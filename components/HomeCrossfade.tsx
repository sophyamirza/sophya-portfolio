      ...
      >
        ...
        <div className="mx-auto max-w-6xl px-6 py-28 min-h-[92vh]">
          <div className="flex flex-col md:flex-row md:gap-12">
            ...
            <div className="flex-1 mt-20 md:mt-28">
              <p
                className="text-right text-3xl md:text-5xl italic text-white/20 tracking-wide select-none pointer-events-none"
                style={{
                  fontFamily: "'Playfair Display', serif",
                  textShadow: "0 0 32px rgba(255,255,255,0.06)",
                }}
              >
        ...
        <div className="mx-auto max-w-6xl px-6 pb-28">
          ...
          <div className="mt-20 flex flex-col items-center gap-5">
            ...
            <Link
              href="/works"
              className="inline-flex items-center justify-center px-10 py-3 rounded-full border border-white/20
                         text-white text-xs tracking-[0.22em] uppercase hover:border-white/60 hover:bg-white/5 transition-all duration-300"
            >
              View All Works →
            </Link>
          </div>
