...
function RailSection({
  ...
  return (
    <div className="pt-7 first:pt-0">
      ...
      <div className={`mt-3 h-[2px] w-32 ${THERMAL} opacity-45`} />
...
export default function BioPage() {
  return (
    <main className="min-h-screen bg-black text-white">
      ...
      {/* widened wrapper (fixes margins) */}
      <div className="relative mx-auto w-full max-w-[1400px] px-10 pb-28 pt-20 md:pt-24">
        {/* top title */}
        ...
        {/* 3-column layout */}
        <div className="mt-14 grid grid-cols-1 gap-10 lg:grid-cols-[420px_minmax(0,1fr)_360px]">
          {/* LEFT: photo (sticky) */}
          ...
          {/* RIGHT: one long sidebar with titled sections + thermal underline */}
          <aside className="lg:sticky lg:top-24 lg:self-start">
