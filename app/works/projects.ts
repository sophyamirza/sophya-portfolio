...
,
...

  {
    ...
    toolsAndSkills: ["HV safety", "Power electronics", "Fixture design"],
    contributions: PH.contributions,
    results: PH.results,
    gallery: [
  ...
  },
  {
    ...
    cover: "/projects/KITTA/KITTA.PNG",
    preview: {
    ...
    team: TEAM_PH,
    systemOverview: "Drone delivery platform work spanning mechanism design and autonomy related system considerations.", 
    toolsAndSkills: ["Mechanism design", "Rapid prototyping", "Integration", ],
    contributions: PH.contributions,
    results: PH.results,
  },
  {
